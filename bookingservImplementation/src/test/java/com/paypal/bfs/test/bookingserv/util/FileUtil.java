...
public class FileUtil {
  ...
  public static Object getObjectFromFile(String fileName, Class tClass) {
    ...
    try {
      ...
      log.error("Unable to parse json file = {} for class = {} exception = {}", fileName, tClass,
          e);
    }
    return object;
  }
  ...
  public static List getObjectListFromFile(String fileName, Class tClass) {
    ...
    try {
      object = objectMapper
          .readValue(is, objectMapper.getTypeFactory().constructCollectionType(List.class, tClass));
    } catch (IOException e) {
      log.error("Unable to parse json file = {} for class = {} exception = {}", fileName, tClass,
          e);
    }
